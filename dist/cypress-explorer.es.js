...
const exWrapper = "ex-wrapper";
const explorerParentStyle = `
  #explorer {
    position: absolute;
    left: 0; 
    right: 0; 
...
`;
const _hoisted_1 = ["id"];
const _hoisted_2 = { class: "ex-wrapper" };
const _hoisted_3 = { class: "ex-form" };
const _hoisted_4 = { class: "ex-ul" };
const _hoisted_5 = ["id", "name", "value", "onInput"];
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    const props = __props;
    const checked = new Map(props.specs.map((spec) => [spec.relative, false]));
    async function handleSubmit() {
      const projectRoot = Cypress.config("projectRoot");
      const specs = Array.from(checked).reduce((acc, curr) => {
        if (curr[1]) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", { id: unref(exWrapper) }, [
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", { class: "ex-top-bar" }, [
            createBaseVNode("button", {
              id: "ex-close-explorer",
              class: "ex-button",
              onClick: handleClose
            }, " \u2716 ")
          ]),
          createBaseVNode("form", _hoisted_3, [
            createBaseVNode("ul", _hoisted_4, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(__props.specs, (spec) => {
                return openBlock(), createElementBlock("li", {
                  ...
                  createBaseVNode("input", {
                    ...
                    class: "ex-input",
                    type: "checkbox",
                    value: unref(checked).get(spec.relative),
                    onInput: ($event) => handleInput(spec.relative)
                  }, null, 40, _hoisted_5),
                  createBaseVNode("label", {
                    for: spec.relative
                  }, toDisplayString(spec.relative), 9, _hoisted_6)
                ]);
              }), 128))
            ])
          ]),
          createBaseVNode("div", { class: "ex-button-wrapper" }, [
            createBaseVNode("button", {
              type: "submit",
...
function openExplorer() {
  ...
  const explorerWrapper = runner.document.querySelector(`#${exWrapper}`);
  if (!explorerWrapper) {
    return;
  }
...
function getIcon() {
  var _a, _b;
  return (_b = (_a = window == null ? void 0 : window.top) == null ? void 0 : _a.document.querySelector(`#${EXPLORER_ICON}`)) != null ? _b : void 0;
}
function injectIcon() {
  var _a;
  const runner = getRunner();
  const sidebar = (_a = runner.document) == null ? void 0 : _a.querySelector(`[aria-label="Pages"]`);
  if (!sidebar) {
...
function injectStyle(id, style) {
  ...
  if ((_a = window.top) == null ? void 0 : _a.document.head.querySelector(`#${styleId}`)) {
    return;
  }
  (_b = window.top) == null ? void 0 : _b.document.head.appendChild(stylesheet);
}
function createExplorer(mount) {
  var _a;
  const runner = getRunner();
  if (!runner.openExplorer) {
    runner.openExplorer = openExplorer;
  }
  const specs = (_a = window == null ? void 0 : window.top) == null ? void 0 : _a.__RUN_MODE_SPECS__;
  function onClose() {
    closeExplorer();
  }
  const app = createApp(_sfc_main, { specs, onClose });
  return () => {
...
function registerCypressExplorer() {
  before(async () => {
    var _a, _b;
    const root = (_a = window == null ? void 0 : window.top) == null ? void 0 : _a.document.querySelector("#app");
    if (!root) {
      throw Error(`Could not find #root`);
    }
    const explorer = (_b = window == null ? void 0 : window.top) == null ? void 0 : _b.document.querySelector("#explorer");
    if (explorer) {
      explorer.remove();
    }
...
export { registerCypressExplorer };
